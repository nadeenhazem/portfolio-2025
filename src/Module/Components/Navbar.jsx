      ...
      ${
        isDark
          ...
          : "bg-gray-700 justify-end"
            ...
            >
              <span
                className={`absolute top-[3px] left-[3px] w-[20px] h-[20px] bg-white rounded-full 
        ...
        {isOpen && (
          <>
            <div className="absolute top-15 left-0 w-full bg-neutral-950 text-white flex flex-col ps-3 py-5 md:hidden">
              {navbarData.map((nav, index) => (
                <a
                  key={index}
                  href={`#${nav.title}`}
